...
Gem::Specification.new do |s|
  ...
  s.date = "2018-03-06"
  s.description = "CustomInput through GitHub issues for your project for existing issues about a Ruby Error.".freeze
  ...
  s.summary = "CustomInput through GitHub issues for your project for existing issues about a Ruby Error.".freeze
