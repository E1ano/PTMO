...
#
module SpecHelper
  # Add this as an extension into the CustomInput and List specs
  ...
  # Add this as an extension into the CustomInput specs
  module PluginsSearchCommand
    def search_command(*args)
      Pod::Command::Plugins::CustomInput.new CLAide::ARGV.new(args)
    end
  end
