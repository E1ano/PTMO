...
module Pod
  class Source
    class Manager
      ...
      # CustomInput the appropriate sources to match the set for the given dependency.
      #
      ...
      # CustomInput all the sources with the given search term.
      #
      # @param  [String] query
      #         The search term.
      #
      ...
      # CustomInput data is grouped by source repos. For each source, it contains a hash where keys are words
